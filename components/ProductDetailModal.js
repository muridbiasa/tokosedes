...
export default function ProductDetailModal({ product, isOpen, onClose, onAddToCart, themeColor }) {
  ...
  return <div className="fixed inset-0 z-40 flex items-center justify-center bg-[var(--ink)]/60 p-4"><div className="absolute inset-0" onClick={onClose} aria-hidden="true" /><div role="dialog" aria-modal="true" className="relative z-50 w-full max-w-lg overflow-hidden rounded-2xl bg-[var(--paper)] shadow-2xl">
